...
&=\frac{\delta\theta}{\theta^{2}}\left< E \right> -\frac{1}{\theta}\sum\left< \frac{\partial E}{\partial\xi_{\lambda}} \right> \delta\xi_{\lambda}
\end{align}

$$
 $\displaystyle \rho=e^{\frac{\phi-E}{\theta}}$，即 $\displaystyle \ln\rho=\frac{\phi-E}{\theta}$，代入整理可得 #疑问 
$$
...
$$
量子力学中粒子具有全同性，微观状态数乘以 $\displaystyle \frac{1}{N!}$，并且相空间的最小体积元为 $\displaystyle \triangle q\triangle p=h$ 则
$$
